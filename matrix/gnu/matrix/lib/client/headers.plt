...
set table '/home/denis/CEO2/plp16/gnu/matrix/bin/data/ppm2.txt'
...
set label 'Î»'  at -21.7,3 center
set arrow from -22, 2 to -21.44,1.92  @Theads
set label 'Î”s' at 3.2,0 center
...
set label 'Î¸' at -15,0 center
# plot sinc function
plot '/home/denis/CEO2/plp16/gnu/matrix/bin/data/ppm2.txt' u ($2*7+3):1 w l ls 2
