...
set table '/home/denis/CEO2/plp16/gnu/matrix/bin/data/ppm1.txt'
# Function to create the right call function
add_loudspeaker(x,y,phi) = sprintf(\
    'call "/home/denis/CEO2/plp16/gnu/matrix/bin/server/gnu.plt" "%f" "%f" "%f" "%f";',x,y,phi,0.2)
# Initialize command string
CMD = ''
# Do a dummy plot to read the loudspeaker position data
plot '/home/denis/CEO2/plp16/gnu/matrix/bin/doc/cpi.plt' u 1:(CMD = CMD.add_loudspeaker($1,$2,$3))
